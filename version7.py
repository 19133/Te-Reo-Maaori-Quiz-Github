...
while True:
  # asks user what difficulty they would like to play
  quiz_difficulty = input ("Would you like to play on easy, medium, or hard\n").lower()

  # if easy, the programw ill print easy questions
  if quiz_difficulty == "easy":
    Question_list = Question_list_easy
    break
  
  # if medium, the programw ill print easy questions
  elif quiz_difficulty == "medium":
    Question_list = Question_list_medium
    break

  # if hard, the programw ill print easy questions
  ...
  # else, the program will ask the user to choose one of the choose difficulties or xxx to quit. Then the question repeats
  else:
